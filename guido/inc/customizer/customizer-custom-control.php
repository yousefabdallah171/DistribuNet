...
if ( class_exists( 'WP_Customize_Control' ) ) {
    class Guido_WP_Customize_Radio_Image_Control extends WP_Customize_Control {
        public $type = 'guido_radio_image';
    ...
    class Guido_WP_Customize_Heading_Control extends WP_Customize_Control {
        public $type = 'guido_heading';
