...
class Guido_Elementor_Address_Box extends Widget_Base {
	...
	public function get_title() {
        return esc_html__( 'Apus Address Box', 'guido' );
    }
	...
	protected function register_controls() {
        ...
        $this->start_controls_section(
            'content_section',
            [
                'label' => esc_html__( 'Address Box', 'guido' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::SELECT,
                'options' => array(
                    'style1' => esc_html__('Horizontal', 'guido'),
                    'style2' => esc_html__('Vertical', 'guido'),
                    'style3' => esc_html__('Circle', 'guido'),
                ),
                'default' => 'style1'
            ]
        );
...
if ( version_compare(ELEMENTOR_VERSION, '3.5.0', '<') ) {
    Plugin::instance()->widgets_manager->register_widget_type( new Guido_Elementor_Address_Box );
} else {
    Plugin::instance()->widgets_manager->register( new Guido_Elementor_Address_Box );
}