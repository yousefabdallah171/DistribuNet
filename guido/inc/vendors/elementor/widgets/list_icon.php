...
class Guido_Elementor_List_Icon extends Widget_Base {
	...
	public function get_title() {
        return esc_html__( 'Apus List Icon', 'guido' );
    }
	...
	protected function register_controls() {
        ...
        $this->start_controls_section(
            'content_section',
            [
                'label' => esc_html__( 'List Icon', 'guido' ),
        ...
        $this->add_responsive_control(
                'margin-title',
                [
                    'label' => esc_html__( 'Margin Title', 'guido' ),
...
if ( version_compare(ELEMENTOR_VERSION, '3.5.0', '<') ) {
    Plugin::instance()->widgets_manager->register_widget_type( new Guido_Elementor_List_Icon );
} else {
    Plugin::instance()->widgets_manager->register( new Guido_Elementor_List_Icon );
}