...
class Guido_Elementor_Listings_Directory_Listing_Categories extends Elementor\Widget_Base {
	...
	public function get_title() {
        return esc_html__( 'Apus Listing Categories', 'guido' );
    }
	...
	protected function register_controls() {
        ...
        $this->start_controls_section(
            'content_section',
            [
                'label' => esc_html__( 'Categories Banner', 'guido' ),
        ...
        $this->add_control(
            'categories',
            [
                'label' => esc_html__( 'Categories Box', 'guido' ),
...
if ( version_compare(ELEMENTOR_VERSION, '3.5.0', '<') ) {
    Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Guido_Elementor_Listings_Directory_Listing_Categories );
} else {
    Elementor\Plugin::instance()->widgets_manager->register( new Guido_Elementor_Listings_Directory_Listing_Categories );
}