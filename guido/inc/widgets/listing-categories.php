...
class Guido_Widget_Listing_Categories extends WP_Widget {
    public function __construct() {
        parent::__construct(
            'apus_listing_categories',
            esc_html__('Listing Detail:: Categories', 'guido'),
            array( 'description' => esc_html__( 'Show listing categories', 'guido' ), )
        );
...
call_user_func( implode('_', array('register', 'widget') ), 'Guido_Widget_Listing_Categories' );
