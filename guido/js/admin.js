jQuery(document).ready(function($){
    ...
    $("body").on("wp_listings_directory_all_loading_icons", function(){
        guido_get_awesome_icons();
        guido_get_flaticon_icons();
        guido_get_themify_icons();
    ...
    function guido_get_awesome_icons() {
    ...
    function guido_get_flaticon_icons() {
        ...
        for( var i=0; i < files.length; i++ ){
            css = Array.prototype.map.call( files[i].sheet.cssRules, guido_css_text ).join('\n');
        ...
        wp_listings_directory_all_loaded_icons.flaticon = icons_load_call;
    }

    function guido_get_themify_icons() {
        ...
        wp_listings_directory_all_loaded_icons.themify = icons_load_call;
    }

    function guido_css_text(x) {
        return x.cssText;
    }
});