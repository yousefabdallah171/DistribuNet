...
$checksidebar = (guido_get_config('blog_single_layout') == 'main') ?'main':'has-sidebar';
?>

	<section id="main-container" class="main-content-detail <?php echo apply_filters( 'guido_blog_content_class', 'container' ); ?> inner <?php echo trim($checksidebar); ?>">
	...
	<?php if ( guido_get_config('show_blog_related', false) ): ?>
