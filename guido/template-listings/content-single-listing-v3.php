...
<article id="post-<?php the_ID(); ?>" <?php post_class('listing-single-layout listing-single-v3'); ?>>
	...
	<div class="<?php echo apply_filters('guido_listing_content_class', 'container');?>">
		<?php echo WP_Listings_Directory_Template_Loader::get_template_part( 'single-listing/gallery-v3' ); ?>
