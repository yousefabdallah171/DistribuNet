...
class WP_Listings_Directory_Template_Loader {
	 ...
	 * @throws Exception
	 */
	public static function locate( $name, $plugin_dir = WP_LISTINGS_DIRECTORY_PLUGIN_DIR ) {
		$template = '';

		$theme_folder_name = apply_filters( 'wp-listings-directory-theme-folder-name', 'wp-listings-directory' );
	 ...
	 * @throws Exception
	 */
	public static function get_template_part( $name, $args = array(), $plugin_dir = WP_LISTINGS_DIRECTORY_PLUGIN_DIR ) {
...
WP_Listings_Directory_Template_Loader::init();