                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td valign="top">Hello
                                                            ...
                                                            Your Listing "{{listing_title}}" is Expired you can renew this listings by login to your Employer account go to Manage Listings &gt; find your listings from listings "{{listing_title}}" Edit your listing select package on step 2 and update your listing by this ways your listings will be publish again.

                                                            Visit the <a href="{{dashboard_url}}">listing listing dashboard</a> to manage the listing.
