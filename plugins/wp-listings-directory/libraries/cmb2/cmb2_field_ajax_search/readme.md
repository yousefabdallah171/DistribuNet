...
function cmb2_ajax_search_metabox() {
	...
	$cmb_demo = new_cmb2_box( array(
		'id'            => $prefix . 'metabox',
		'title'         => __( 'Attached posts Metabox', 'wp-listings-directory' ),
		'object_types'  => array( 'page', 'post' ), // Post type
	) );

	// Single post
	$cmb_demo->add_field( array(
		'name'          => __( 'Attached post', 'wp-listings-directory' ),
		'desc'          => __( 'Field description (optional)', 'wp-listings-directory' ),
		'id'            => $prefix . 'post',
	...
	// Multiple posts
	$cmb_demo->add_field( array(
		'name'          => __( 'Multiple posts', 'wp-listings-directory' ),
		'desc'          => __( 'Field description (optional)', 'wp-listings-directory' ),
		'id'            => $prefix . 'posts',
		'type'          => 'post_ajax_search',
		'multiple'      => true,
	...
	// Single user
	$cmb_demo->add_field( array(
		'name'          => __( 'Attached user', 'wp-listings-directory' ),
		'desc'          => __( 'Field description (optional)', 'wp-listings-directory' ),
		'id'            => $prefix . 'user',
	...
	// Multiple users
	$cmb_demo->add_field( array(
		'name'          => __( 'Multiple users', 'wp-listings-directory' ),
		'desc'          => __( 'Field description (optional)', 'wp-listings-directory' ),
		'id'            => $prefix . 'users',
		'type'          => 'user_ajax_search',
		'multiple'      => true,
	...
	// Single term
	$cmb_demo->add_field( array(
		'name'          => __( 'Attached term', 'wp-listings-directory' ),
		'desc'          => __( 'Field description (optional)', 'wp-listings-directory' ),
		'id'            => $prefix . 'term',
	...
	// Multiple terms
	$cmb_demo->add_field( array(
		'name'          => __( 'Multiple terms', 'wp-listings-directory' ),
		'desc'          => __( 'Field description (optional)', 'wp-listings-directory' ),
		'id'            => $prefix . 'terms',
		'type'          => 'term_ajax_search',
		'multiple'      => true,
