...
class WP_Listings_Directory_CMB2_Field_Tags {

	public static function init() {
		add_filter( 'cmb2_render_wp_listings_directory_tags', array( __CLASS__, 'render_map' ), 10, 5 );
		add_filter( 'cmb2_sanitize_wp_listings_directory_tags', array( __CLASS__, 'sanitize_map' ), 10, 4 );	
	}
...
WP_Listings_Directory_CMB2_Field_Tags::init();